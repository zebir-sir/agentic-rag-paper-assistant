...
def build_langchain_tools(deps: AgentDependencies) -> list:
    ...
    return [
        StructuredTool.from_function(
            ...
            description="Search the knowledge base using configured default search type.",
        ...
        StructuredTool.from_function(
            ...
            description="Search OpenAlex papers when web search is enabled.",
        ...
        StructuredTool.from_function(
            ...
            name="search_web",
            description=(
                "Search the general web for technical explanations, definitions, "
                "recent information, software docs, or non-paper sources. "
                "Use this when the user asks for web sources or asks a general technical question "
                "that is not specifically about uploaded papers or OpenAlex paper discovery."
            ),
